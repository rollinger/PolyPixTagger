...
class OverlayRenderer:
    ...
    Also owns QGraphicsPixmapItem per layer and toggles visibility.
    """
    ...
    def update_layer_overlay(self, layer: Layer, dirty_rect: QtCore.QRect):
        """Updates overlay_rgba_img pixels in dirty rect and pushes pixmap to scene (v4 behavior)."""
        p = self.state.project
        if not p.image_path:
            return
        ...
        # Push overlay pixmap (still immediate; throttling can be added later)
