...
class PixTagMainWindow(QtWidgets.QMainWindow):
    ...
    def _build_actions(self):
        act_open = QtGui.QAction("Import image…", self)
        act_open.triggered.connect(self.import_image)

        act_save = QtGui.QAction("Save project JSON…", self)
        act_save.triggered.connect(self.save_project_json)

        act_load = QtGui.QAction("Load project JSON…", self)
